...
module.exports = (sequelize, DataTypes) => {
  return sequelize.define("Pokemon", {
      ...
      name: {
        ...
        validate: {
          notEmpty: { msg: 'Le nom doit être rempli.' },
      ...
      cp: {
        ...
        validate: {
          ...
          min: {
            args: [0],
            msg: 'Les points de dégat doivent être supérieurs ou égaux à 0'
          },
          max: {
            args: [99],
            msg: 'Les points de dégat doivent être inférieurs ou égaux à 99'
          },
      ...
      picture: {
        ...
        allowNull: false,
        validate: {
          isUrl: { msg: 'Utilisez unqieuement une url valide pour l\'image.' },
